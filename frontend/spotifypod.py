...
class StartPage(tk.Frame): 
    def __init__(self, parent, controller):  
        tk.Frame.__init__(self, parent)
        print("  Screen width: " + self.winfo_vrootwidth())
        print("  Screen height: " + self.winfo_vrootheight())
        ...
        self.header_label = tk.Label(header_container, text ="Musikbox Felix", font = LARGEFONT, background=SPOT_BLACK, foreground=SPOT_GREEN) 
